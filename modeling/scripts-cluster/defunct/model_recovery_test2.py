...
# save
with open('modrec_self_norm_all_grp.pkl','wb') as f:
    pickle.dump([modrec_seeds_self_norm_all_grp,modrec_maps_self_norm_all_grp,modrec_logprobs_self_norm_all_grp],f)
...
# save
with open('modrec_self_norm_all_dim.pkl','wb') as f:
    pickle.dump([modrec_seeds_self_norm_all_dim,modrec_maps_self_norm_all_dim,modrec_logprobs_self_norm_all_dim],f)
...
modrec_seeds_self_raw_noauto_grp, modrec_maps_self_raw_noauto_grp, modrec_logprobs_self_raw_noauto_grp = tomtom_refit(gendat_self_raw_grp)
...
modrec_seeds_self_raw_noauto_dim, modrec_maps_self_raw_noauto_dim, modrec_logprobs_self_raw_noauto_dim = tomtom_refit(gendat_self_raw_dim)

# save
with open('modrec_self_raw_noauto_dim.pkl','wb') as f:
    pickle.dump([modrec_seeds_self_raw_noauto_dim,modrec_maps_self_raw_noauto_dim,modrec_logprobs_self_raw_noauto_dim],f)
