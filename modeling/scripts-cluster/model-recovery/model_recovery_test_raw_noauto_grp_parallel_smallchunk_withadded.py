...
with open('tomtom_fitted_models_withadded.pkl','rb') as f:
...
with open('model_recovery_gen_dat_small_withadded.pkl','rb') as f:
    [gendat_self_norm_all_grp,gendat_self_norm_all_dim,
...
gendat = gendat_self_raw_noauto_grp
kmap = gendat[kgroup]
...
# save
fname = 'modrec_self_raw_noauto_grp_cross_k{}_withadded.pkl'.format(kgroup)
