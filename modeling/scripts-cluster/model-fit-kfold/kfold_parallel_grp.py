...
if __name__ == '__main__':
    ...
    phn = tm.ParallelEvaluator(trunc_data, 'self','raw','noauto','grp', maxk = 10, K = k, random_state = 888)
    q = phn.evaluate_parallel_alt()

    with open('kfold_metrics_grp_k{}.pkl'.format(k),'wb') as f:
        pickle.dump([q],f)
